...
},
{
  ...
  "body": [
    ...
    "## 四处证据\n\n| 场合 | 单点时的问题 | 你最后用的对照 |\n|---|---|---|\n| [[用户可感知的价值与差异化表达]] | 罗列功能，说不清价值 | 不用它 / 用别家 vs 用它 |\n| [[数据指标的解读]] | 只有整体成交，看着挺好 | 整体 ROI **对**净 ROI，差值 = 风险敞口 |\n| [[用户访谈与需求挖掘]] | 只准备问题清单，对方不知从何说起 | 我的具体困境 **换** 他的真实经历 |\n| [[Agent模型接入与额度机制]] | \"provider 和 key 是一样的吗\" | provider（渠道）vs key（凭证）分开 |",
